...
//##########-------------------------------------------------------------------------------
//#################################--------- EE 352 Final Project Anthony Wittemann -------
//##---------------------------------------------------------------------------------------
...
public class CacheSimluator {
	...
	private static final int MISS_PENALTY = 10;
	...
	private static void performSimulation() {
		...
		while(totalRuntime < MAX_SIMULATION_TIME){
			...
			int randomAddress = (int) Math.abs((256) * Math.random()); //2^8
	...
	private static void calculateOutputs() {
		...
		avgMemAccessLatency = ((double) totalRuntime) / ((double) totalMemCalls);
	}
